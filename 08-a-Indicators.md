...
1. A unique title for the indicator.
2. A clear and unambiguous definition of the indicator.
3. The unit of measure to use for the indicator.
4. The purpose of the indicator.
5. A rationale justifying the indicator's relevance to the states or impacts it is intended to describe.
